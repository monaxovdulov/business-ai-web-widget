...
function ne(t = {}) {
  const e = { ...P, ...t }, s = be(e.timeoutMs, P.timeoutMs, 6e4), i = be(e.maxMessageLength, P.maxMessageLength, 1e4);
  return {
    ...e,
    apiBaseUrl: lt(f(e.apiBaseUrl)),
    messagesPath: at(e.messagesPath),
    timeoutMs: s,
    widgetInstanceId: f(e.widgetInstanceId) || P.widgetInstanceId,
    theme: f(e.theme) || P.theme,
    position: st(e.position),
    panelSize: it(e.panelSize),
    mock: !!e.mock,
    initialState: ot(e.initialState),
    persistOpenState: !!e.persistOpenState,
    storage: rt(e.storage),
    quickReplySubmit: nt(e.quickReplySubmit),
...
function me(t) {
  const e = {
    ...et(t),
    ...Re(t.getAttribute("config"))
  };
  for (const [s, i] of Object.entries(Le)) {
    if (!t.hasAttribute(s)) continue;
    const o = t.getAttribute(s);
    o != null && (Ze.has(i) ? e[i] = tt(o) : Je.has(i) ? e[i] = Number(o) : e[i] = o);
  }
  return t.hasAttribute("quick-replies") && (e.quickReplies = Ye(t.getAttribute("quick-replies") ?? "")), t.hasAttribute("mobile-actions") && (e.mobileActions = Xe(t.getAttribute("mobile-actions") ?? "")), ne(e);
}
function Ge(t, e = {}) {
  const s = ne(e);
...
function et(t) {
  ...
  return e?.textContent ? Re(e.textContent) : {};
}
function Re(t) {
  if (!t?.trim()) return {};
  const e = ae(t);
 ...
 */
const Q = globalThis, le = Q.ShadowRoot && (Q.ShadyCSS === void 0 || Q.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ce = Symbol(), we = /* @__PURE__ */ new WeakMap();
let Ue = class {
  constructor(e, s, i) {
...
}, xe = le ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: dt, defineProperty: pt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: ft, getOwnPropertySymbols: gt, getPrototypeOf: mt } = Object, J = globalThis, ye = J.trustedTypes, bt = ye ? ye.emptyScript : "", wt = J.reactiveElementPolyfillSupport, U = (t, e) => t, oe = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? bt : null;
      break;
  ...
  return s;
} }, qe = (t, e) => !dt(t, e), ve = { attribute: !0, type: String, converter: oe, reflect: !1, useDefault: !1, hasChanged: qe };
...
let z = class extends HTMLElement {
  ...
  requestUpdate(e, s, i, o = !1, r) {
    if (e !== void 0) {
      ...
      if (o === !1 && (r = this[e]), i ??= n.getPropertyOptions(e), !((i.hasChanged ?? qe)(r, s) || i.useDefault && i.reflect && r === this._$Ej?.get(e) && !this.hasAttribute(n._$Eu(e, i)))) return;
      this.C(e, s, i);
    }
...
z.elementStyles = [], z.shadowRootOptions = { mode: "open" }, z[U("elementProperties")] = /* @__PURE__ */ new Map(), z[U("finalized")] = /* @__PURE__ */ new Map(), wt?.({ ReactiveElement: z }), (J.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const he = globalThis, $e = (t) => t, Z = he.trustedTypes, Se = Z ? Z.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Be = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, He = "?" + A, xt = `<${He}>`, M = document, B = () => M.createComment(""), H = (t) => t === null || typeof t != "object" && typeof t != "function", de = Array.isArray, yt = (t) => de(t) || typeof t?.[Symbol.iterator] == "function", Y = `[ 	
\f\r]`, O = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _e = /-->/g, Ae = />/g, k = RegExp(`>|${Y}(?:([^\\s"'>=/]+)(${Y}*=${Y}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ke = /'/g, Ee = /"/g, De = /^(?:script|style|textarea|title)$/i, je = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), v = je(1), m = je(2), C = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), Me = /* @__PURE__ */ new WeakMap(), E = M.createTreeWalker(M, 129);
function We(t, e) {
...
const vt = (t, e) => {
  ...
  for (let h = 0; h < s; h++) {
    const a = t[h];
    let l, d, p = -1, $ = 0;
    for (; $ < a.length && (n.lastIndex = $, d = n.exec(a), d !== null); ) $ = n.lastIndex, n === O ? d[1] === "!--" ? n = _e : d[1] !== void 0 ? n = Ae : d[2] !== void 0 ? (De.test(d[2]) && (o = RegExp("</" + d[2], "g")), n = k) : d[3] !== void 0 && (n = k) : n === k ? d[0] === ">" ? (n = o ?? O, p = -1) : d[1] === void 0 ? p = -2 : (p = n.lastIndex - d[2].length, l = d[1], n = d[3] === void 0 ? k : d[3] === '"' ? Ee : ke) : n === Ee || n === ke ? n = k : n === _e || n === Ae ? n = O : (n = k, o = void 0);
    const S = n === k && t[h + 1].startsWith("/>") ? " " : "";
    r += n === O ? a + xt : p >= 0 ? (i.push(l), a.slice(0, p) + Be + a.slice(p) + A + S) : a + A + (p === -2 ? h : S);
  }
...
class D {
  constructor({ strings: e, _$litType$: s }, i) {
    ...
    this.parts = [];
    let r = 0, n = 0;
    const h = e.length - 1, a = this.parts, [l, d] = vt(e, s);
    ...
    for (; (o = E.nextNode()) !== null && a.length < h; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const p of o.getAttributeNames()) if (p.endsWith(Be)) {
          ...
          a.push({ type: 1, index: r, name: W[2], strings: S, ctor: W[1] === "." ? St : W[1] === "?" ? _t : W[1] === "@" ? At : G }), o.removeAttribute(p);
      ...
      } else if (o.nodeType === 8) if (o.data === He) a.push({ type: 2, index: r });
      else {
        let p = -1;
...
class $t {
  ...
  u(e) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let l;
        a.type === 2 ? l = new j(r, r.nextSibling, this, e) : a.type === 1 ? l = new a.ctor(r, a.name, a.strings, this, e) : a.type === 6 && (l = new kt(r, this, e)), this._$AV.push(l), a = i[++h];
      }
...
class j {
  ...
  _$AI(e, s = this) {
    e = T(this, e, s), H(e) ? e === u || e == null || e === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : e !== this._$AH && e !== C && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : yt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    const { values: s, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = D.createElement(We(i.h, i.h[0]), this.options)), i);
    if (this._$AH?._$AD === o) this._$AH.p(s);
    else {
      const r = new $t(o, this), n = r.u(this.options);
      r.p(s), this.T(n), this._$AH = r;
    }
  }
  _$AC(e) {
    let s = Me.get(e.strings);
    return s === void 0 && Me.set(e.strings, s = new D(e)), s;
  }
  k(e) {
...
const Et = he.litHtmlPolyfillSupport;
Et?.(D, j), (he.litHtmlVersions ??= []).push("3.3.3");
const Mt = (t, e, s) => {
...
N._$litElement$ = !0, N.finalized = !0, pe.litElementHydrateSupport?.({ LitElement: N });
...
function Tt(t) {
  return `site-widget:${Lt(t) || "anonymous"}:${Date.now()}:${ue()}`;
}
function Ot(t) {
  let e = 2166136261;
...
function Rt(t) {
  const e = Nt(t.contact), s = Ut(t.environment.search), i = q({
    channel: "site_widget",
  ...
  switch (e.type) {
    ...
    case "draft.changed": {
      ...
      return {
        ...i,
        draft: o,
        status: i.open ? o.trim() ? "composing" : Ie(i, s) : i.status
      };
    }
...
function Ie(t, e) {
  const s = e ? fe(t.draft, e) : t.draft.trim() ? null : "empty_message";
...
function Ht(t, e) {
  const s = fe(t.draft, e), i = t.visitorMessageCount > 0;
  return {
    ...t,
...
const Ce = "granit-site-widget", Te = "granit-widget", Dt = {
  opened: "open",
  closed: "close",
...
function y(t, e, s, i = {}) {
  const o = jt(i, s);
  V(t, `${Ce}:${e}`, o), V(t, `${Te}:${e}`, o);
  const r = Dt[e];
  r && (V(t, `${Ce}:${r}`, o), V(t, `${Te}:${r}`, o));
}
function jt(t, e) {
  const s = {
    ...t,
  ...
  return typeof s.publicSessionId == "string" && (s.publicSessionIdHash = Ot(s.publicSessionId), delete s.publicSessionId), e.includeMessageTextInEvents || (typeof s.messageText == "string" && (s.messageLength = s.messageText.length), delete s.messageText), s;
}
function V(t, e, s) {
  t.dispatchEvent(
    new CustomEvent(e, {
...
function Wt(t = /* @__PURE__ */ new Date()) {
  return {
...
function Oe(t, e = "local") {
  const s = `sw:${t}:public_session_id`, i = `sw:${t}:open_state`, o = `sw:${t}:panel_size`, r = e === "memory" ? void 0 : Xt();
  let n = "", h, a;
  return {
    getPublicSessionId() {
      const l = te(r, s) || n;
...
function is(t, e) {
  ...
  return v`<article class=${os(t)} part=${i}>
...
const Ke = "granit-site-widget", rs = ["normal", "wide", "fullscreen"], ns = ["normal", "fullscreen"], as = {
  normal: "обычный размер",
  wide: "широкий режим",
  fullscreen: "на весь экран"
}, ge = class ge extends N {
  constructor() {
    super(...arguments), this.config = ne(), this.state = Pe({ config: this.config }), this.panelSize = "normal", this.hasBooted = !1, this.publicSessionId = "", this.cyclePanelSize = () => {
  ...
  static get observedAttributes() {
    return [...super.observedAttributes, ...Qe];
  }
  connectedCallback() {
  ...
  attributeChangedCallback(e, s, i) {
    ...
    this.config = me(this), this.syncHostAttributes(), (o !== this.config.widgetInstanceId || r !== this.config.storage) && (this.sessionStore = Oe(this.config.widgetInstanceId, this.config.storage), this.publicSessionId = this.sessionStore.getPublicSessionId()), e === "panel-size" && (this.panelSize = this.config.panelSize), e === "open" && (this.state = g(this.state, this.hasAttribute("open") ? { type: "open" } : { type: "close" }, this.config)), this.requestUpdate();
  }
  open() {
  ...
  render() {
    const e = Ht(this.state, this.config), s = this.getEffectivePanelSize(), i = this.getPanelSizeButtonLabel(), o = s === "fullscreen" ? "minimize-2" : "maximize-2";
    return v`
      <button
        class="launcher"
        part="launcher"
      ...
      >
        ...
        <div class="body" part="body">
          <div class="messages" part="messages" role="log" aria-live="polite" aria-relevant="additions">
            ${e.messages.map((r) => is(r, this.config))}
          </div>
  ...
  boot() {
    ...
    this.config = me(this), this.syncHostAttributes(), this.sessionStore = Oe(this.config.widgetInstanceId, this.config.storage), this.publicSessionId = this.sessionStore.getPublicSessionId(), this.panelSize = this.sessionStore.getPanelSize() ?? this.config.panelSize;
    ...
    this.state = Pe({ config: this.config, open: s }), s && !this.hasAttribute("open") && this.setAttribute("open", ""), this.hasBooted = !0, this.updateComplete.then(() => {
  ...
  getPanelSizeButtonLabel() {
    return `${this.config.resizeLabel}: ${as[this.getNextPanelSize()]}`;
  }
  getNextPanelSize() {
  ...
  getPanelSizeOrder() {
    return this.isMobileViewport() ? ns : rs;
  }
  isMobileViewport() {
  ...
  async submitDraft() {
    ...
    if (fe(e, this.config) || this.state.submitting) return;
    const s = Tt(this.publicSessionId);
  ...
  async sendPending(e, s) {
    ...
    try {
      ...
      const o = await Ft(this.config, i, this.abortController.signal);
...
function ds(t = {}) {
  ...
  ls();
  const e = document.createElement(Ke);
  Ge(e, t);
...
export {
  ...
  Ke as SITE_WIDGET_TAG_NAME,
  ls as defineSiteWidget,
  ds as mountSiteWidget
};
