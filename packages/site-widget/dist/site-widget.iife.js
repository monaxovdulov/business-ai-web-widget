...
`;function S(s,e=22){const t={width:e,height:e};switch(s){case"send":return A(t,x`<path d="m22 2-7 20-4-9-9-4Z" /><path d="M22 2 11 13" />`);case"phone":return A(t,x`<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.35 1.77.7 2.61a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.84.35 1.71.58 2.61.7A2 2 0 0 1 22 16.92Z" />`);case"calculator":return A(t,x`<rect x="4" y="2" width="16" height="20" rx="2" /><path d="M8 6h8" /><path d="M16 14v4" /><path d="M8 10h.01" /><path d="M12 10h.01" /><path d="M16 10h.01" /><path d="M8 14h.01" /><path d="M12 14h.01" /><path d="M8 18h.01" /><path d="M12 18h.01" />`);case"close":return A(t,x`<path d="M18 6 6 18" /><path d="m6 6 12 12" />`);case"minus":return A(t,x`<path d="M5 12h14" />`);case"paperclip":return A(t,x`<path d="m16 6-8.41 8.59a2 2 0 0 0 2.82 2.82l8.42-8.58a4 4 0 1 0-5.66-5.66l-8.38 8.55a6 6 0 1 0 8.49 8.49l8.38-8.55" />`);case"shield":return A(t,x`<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.68 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.5 3.8 17 5 19 5a1 1 0 0 1 1 1Z" /><path d="m9 12 2 2 4-4" />`);case"brand":return A(t,x`<path d="m8 3 4 8 5-5 5 15H2Z" />`);case"plus":return A(t,x`<path d="M5 12h14" /><path d="M12 5v14" />`);case"maximize-2":case"expand":return A(t,x`<path d="M15 3h6v6" /><path d="m21 3-7 7" /><path d="m3 21 7-7" /><path d="M9 21H3v-6" />`);case"minimize-2":case"shrink":return A(t,x`<path d="M4 14h6v6" /><path d="M20 10h-6V4" /><path d="m14 10 7-7" /><path d="m3 21 7-7" />`);case"spark":return A(t,x`<path d="M9.94 15.5A2 2 0 0 0 8.5 14.06l-6.14-1.58a.5.5 0 0 1 0-.96L8.5 9.94A2 2 0 0 0 9.94 8.5l1.58-6.14a.5.5 0 0 1 .96 0l1.58 6.14a2 2 0 0 0 1.44 1.44l6.14 1.58a.5.5 0 0 1 0 .96l-6.14 1.58a2 2 0 0 0-1.44 1.44l-1.58 6.14a.5.5 0 0 1-.96 0Z" /><path d="M20 3v4" /><path d="M22 5h-4" /><path d="M4 17v2" /><path d="M5 18H3" />`);case"loader":return A(t,x`<path d="M21 12a9 9 0 1 1-2.64-6.36" />`);case"message":default:return A(t,x`<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" /><path d="M8 12h.01" /><path d="M12 12h.01" /><path d="M16 12h.01" />`)}}function A(s,e){return x`<svg
    aria-hidden="true"
    width=${s.width}
    height=${s.height}
    viewBox="0 0 24 24"
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ki=gt(class extends ft{constructor(){super(...arguments),this.key=p}render(s,e){return this.key=s,e}update(s,[e,t]){return e!==this.key&&(wt(s),this.key=e),t}}),Vi="image/jpeg,image/png,image/webp",Dt="Добавить фото";function Gi({label:s=Dt,disabled:e=!1,onFilesSelected:t}){const i=s.trim()||Dt;return f`
    <button
      class="attach-button"
      part="attach-button"
      type="button"
    ...
    <input
      ...
      @change=${o=>Ji(o,t)}
    />
  `}function Yi({attachments:s,validationMessage:e="",validationRevision:t=0,onRemove:i}){const o=e.trim();return f`
    ${o?Ki(t,f`<p class="attachment-validation" role="alert" data-validation-revision=${t}>
            ${o}
          </p>`):p}
    ...
    ${s.length>0?f`
          <ul class="attachment-list" part="attachment-list" aria-label="Выбранные фото">
            ${s.map((r,n)=>{const l=n+1;return f`
        ...
        `:p}
  `}function Qi(s){return s.length===0?p:f`
  ...
  `}function Zi(s){const e=s.currentTarget;if(!(e instanceof HTMLButtonElement))return;const t=e.nextElementSibling;t instanceof HTMLInputElement&&!t.disabled&&t.click()}function Ji(s,e){const t=s.currentTarget;if(!(t instanceof HTMLInputElement))return;const i=t.files?Array.from(t.files):[];t.value="",i.length>0&&e(i)}function Xi(s){return`Выбрано фото: ${s}`}function eo(s){const e=Math.max(0,Math.floor(s));return e<1024?`${e} Б`:e<1048576?`${Bt(e/1024)} КБ`:`${Bt(e/1048576)} МБ`}function Bt(s){const e=s>=10?0:1;return s.toFixed(e).replace(".",",")}function ve(s){return Math.max(1,Math.floor(s))}function to(s,e){return s.role==="system"?no(s):so(s,e)}function so(s,e){return f`<div
  ...
  >
    ${io(s,e)} ${oo(s,e)}
  </div>`}function io(s,e){return f`<article class=${mo(s)} part=${`message message-${s.role} message-bubble`}>
    ...
    ${Qi(e.images??[])}
  </article>`}function oo(s,e){const t=s.status==="pending"||s.status==="saved"||s.status==="error",i=lo(s.createdAt),o=ho(s.createdAt);return s.localKind==="intro"&&!s.disclosure&&!t?p:f`<div class="message-meta" part="message-meta">
  ...
  </div>`}function ro(s,e){return s.status!=="error"?p:f`<div class="message-actions" part="message-actions">
    <span aria-hidden="true">·</span>
    <button
      class="retry-button"
      part="retry-button"
  ...
  </div>`}function no(s){return f`<div
    class="marker"
  ...
  >
  ...
  </div>`}function ao(s,e,t=new Date){if(s.localKind==="intro")return p;const i=we(s.createdAt),o=e&&e.localKind!=="intro"?we(e.createdAt):void 0;return!i||o&&Ne(i,o)?p:f`<div class="date-separator" part="date-separator" role="separator">
    <span>${po(i,t)}</span>
  </div>`}function co(){return f`<div class="typing" part="typing-indicator" role="status" aria-label="AI-помощник печатает">
      ...
      >
        ...
        <div class="body" part="body">
          ...
          ${e.showQuickReplies?f`<div class="quick-replies" part="quick-replies">
                ${this.config.quickReplies.map(d=>f`<button
                    class="quick-reply"
                    part="quick-reply"
                    type="button"
    ...
    >
      ${S(t,20)}
      <span>${e.label}</span>
    </button>`}handleMobileAction(e){E(this,"action-clicked",this.config,{actionType:e.type}),this.open(),e.type==="prefill"&&(this.state=v(this.state,{type:"draft.changed",value:e.text},this.config),this.requestUpdate(),this.focusInputSoon())}async submitDraft(){if(!this.isConnected)return;const e=this.operationEpoch;let t=this.state.draft.trim();if(ue(t,this.config)||this.state.submitting||this.state.pending||this.isPhotoPreviewEnabled()&&this.imageAttachments.isProcessing()&&(await this.imageAttachments.whenIdle(),e!==this.operationEpoch||!this.isConnected||(t=this.state.draft.trim(),ue(t,this.config)||this.state.submitting||this.state.pending))||e!==this.operationEpoch||!this.isConnected)return;const i=Cs(this.publicSessionId);this.state=v(this.state,{type:"submit.started",text:t,idempotencyKey:i},this.config);const o=this.state.pending;!o||o.idempotencyKey!==i||(this.isPhotoPreviewEnabled()&&this.imageAttachments.transferDraftToMessage(o.messageId),this.requestUpdate(),await this.sendPending(o,e))}async sendPending(e,t){this.abortController?.abort();const i=new AbortController;this.abortController=i;const{messageId:o,text:r,idempotencyKey:n}=e,l=()=>this.operationEpoch===t&&this.abortController===i&&!i.signal.aborted&&this.isConnected&&this.state.pending?.messageId===o&&this.state.pending.idempotencyKey===n;try{const a=Zs({config:this.config,text:r,publicSessionId:this.publicSessionId,idempotencyKey:n,contact:this.buildContact(),environment:ri()});if(E(this,"message-submitted",this.config,{idempotencyKey:n,publicSessionId:this.publicSessionId,messageText:r}),!l())return;const c=await this.sendMessageRequest(this.config,a,i.signal);if(!l())return;if(c.source==="server"){if(this.publicSessionId&&c.publicSessionId!==this.publicSessionId)throw new Error("Invalid site_widget.v2 response: public_session_id_mismatch");this.publicSessionId=c.publicSessionId,this.sessionStore?.setPublicSessionId(c.publicSessionId),this.state=v(this.state,{type:"visitor.saved",messageId:o,publicMessageId:c.publicMessageId,acceptanceStatus:c.acceptanceStatus,submittedAt:c.submittedAt,awaitingAi:c.status==="processing"},this.config)}else this.state=v(this.state,{type:"visitor.mocked",messageId:o},this.config);if(c.status==="processing")this.startHistoryPolling(c.pollAfterMs);else if(c.status==="replied"){if(!c.replyText)throw new Error("Widget replied response is missing reply text");this.state=v(this.state,{type:"assistant.replied",text:c.replyText,publicMessageId:c.source==="server"?c.replyPublicMessageId:void 0,disclosureText:c.source==="server"?c.disclosureText:void 0},this.config)}else{const d=c.status==="disabled"?"disabled":"fallback";this.state=v(this.state,{type:"system.message",text:c.systemText||this.config.fallbackMessage,status:d},this.config),E(this,"fallback-shown",this.config,{status:d,reason:c.status==="fallback"&&"reason"in c?c.reason??"":""})}E(this,"response-received",this.config,{status:c.status,acceptanceStatus:c.source==="server"?c.acceptanceStatus:"mock",reason:c.status==="fallback"&&"reason"in c?c.reason??"":""}),this.requestUpdate()}catch(a){if(a instanceof DOMException&&a.name==="AbortError"&&i.signal.aborted||!l())return;this.state=v(this.state,{type:"submit.failed",text:this.config.errorMessage,messageId:o},this.config),E(this,"error",this.config,{errorMessage:a instanceof Error?a.message:String(a)}),this.requestUpdate()}finally{this.abortController===i&&(this.abortController=void 0)}}invalidateActiveWork(e){this.operationEpoch+=1;const t=this.abortController;this.abortController=void 0,t?.abort(),this.historyEpoch+=1;const i=this.historyAbortController;this.historyAbortController=void 0,i?.abort(),e&&this.state.pending&&this.state.submitting&&(this.state=v(this.state,{type:"submit.failed",text:this.config.errorMessage,messageId:this.state.pending.messageId},this.config))}startHistoryPolling(e){if(!this.publicSessionId||this.config.mock||!this.isConnected)return;this.historyAbortController?.abort();const t=new AbortController,i=++this.historyEpoch;this.historyAbortController=t,this.pollHistory(i,t,e)}async pollHistory(e,t,i){let o=Math.max(0,i),r=0;for(;e===this.historyEpoch&&this.historyAbortController===t&&!t.signal.aborted&&this.isConnected;)try{o>0&&await vo(o,t.signal);const n=await Bi(this.config,this.publicSessionId,t.signal);if(n.publicSessionId!==this.publicSessionId)throw new Error("Invalid site_widget.history.v2 response: public_session_id_mismatch");r=0;const l=n.pollAfterMs!==void 0||n.messages.some(a=>a.automation?.status==="pending"||a.automation?.status==="processing"||a.automation?.status==="retrying");if(this.state=v(this.state,{type:"history.synced",messages:n.messages,awaitingAi:l,conversationState:n.conversationState},this.config),!l)if(n.conversationState==="manager_pending"||n.conversationState==="manager_active")this.state=v(this.state,{type:"system.message",text:this.config.disabledMessage,status:"disabled"},this.config);else{const a=[...n.messages].reverse().find(c=>c.automation&&(c.automation.status==="degraded"||c.automation.status==="failed"||c.automation.status==="blocked"));a?.automation?.status==="blocked"?this.state=v(this.state,{type:"system.message",text:this.config.disabledMessage,status:"disabled"},this.config):a&&(this.state=v(this.state,{type:"system.message",text:this.config.fallbackMessage,status:"fallback"},this.config))}if(this.requestUpdate(),!l)break;o=n.pollAfterMs??700}catch(n){if(t.signal.aborted||e!==this.historyEpoch)return;if(n instanceof Error&&n.message.includes("HTTP 404")){this.sessionStore?.clearPublicSessionId(),this.publicSessionId="",this.state=v(this.state,{type:"session.cleared"},this.config),this.requestUpdate();break}r+=1,o=Math.min(500*2**Math.min(r,3),4e3),r===1&&E(this,"error",this.config,{errorMessage:n instanceof Error?n.message:String(n)})}this.historyAbortController===t&&(this.historyAbortController=void 0)}buildContact(){const e=this.state.contactPhone.trim();return e?{phone:e,preferred_contact:"phone"}:void 0}isPhotoPreviewEnabled(){return this.config.mock&&this.config.attachmentsEnabled&&this.config.showAttachmentSlot}autoGrowTextarea(){const e=this.renderRoot.querySelector(".textarea");e&&(e.style.height="auto",e.style.height=`${Math.min(e.scrollHeight,118)}px`)}async focusInputSoon(){await this.updateComplete,this.renderRoot.querySelector(".textarea")?.focus()}async focusLauncherSoon(){await this.updateComplete,this.renderRoot.querySelector(".launcher")?.focus()}};je.styles=[Wi,ji];let Fe=je;function vo(s,e){return e.aborted?Promise.reject(new DOMException("Aborted","AbortError")):new Promise((t,i)=>{const o=globalThis.setTimeout(n,Math.max(0,s)),r=()=>{globalThis.clearTimeout(o),e.removeEventListener("abort",r),i(new DOMException("Aborted","AbortError"))};function n(){e.removeEventListener("abort",r),t()}e.addEventListener("abort",r,{once:!0})})}function ye(s=_e){typeof window>"u"||!window.customElements||window.customElements.get(s)||window.customElements.define(s,Fe)}function qt(s={}){if(typeof document>"u")throw new Error("mountSiteWidget requires a browser document");ye();const e=document.createElement(_e);Gt(e,s);const t=s.target??document.body;if(!t)throw new Error("mountSiteWidget target was not found");return t.appendChild(e),e}return ye(),typeof window<"u"&&(window.GranitSiteWidget={define:ye,mount:qt,tagName:_e}),K.SITE_WIDGET_TAG_NAME=_e,K.defineSiteWidget=ye,K.mountSiteWidget=qt,Object.defineProperty(K,Symbol.toStringTag,{value:"Module"}),K})({});
